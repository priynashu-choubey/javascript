...
initialized with the corresponding values from the person object. This avoids
repetitive code and makes accessing object properties more efficient.
Destructuring can also be used to rename properties during extraction, 
set default values if a property is missing, and extract properties from 
nested objects. It is a powerful feature that improves code maintainability 
and readability.
*/
